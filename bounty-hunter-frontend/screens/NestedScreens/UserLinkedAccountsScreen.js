            ...
            <View style={styles.page}>
                ...
                <View style={styles.container}>
                    ...
                    <View style={styles.buttonContainer}>
                        <IconButton icon='trash' color={GLOBAL_STYLES.colors.blue300}
                        onPress={() => deletePaymentHandler('venmo')} iconSize={28}/>
                        <IconButton icon='checkbox' color={GLOBAL_STYLES.colors.blue300}
                        onPress={saveVenmoHandler} iconSize={28}/>
                    </View>
                </View>
                <View style={styles.container}>
                    ...
                    <View style={styles.buttonContainer}>
                        <IconButton icon='trash' color={GLOBAL_STYLES.colors.blue300}
                        onPress={() => deletePaymentHandler('zelle')} iconSize={28}/>
                        <IconButton icon='checkbox' color={GLOBAL_STYLES.colors.blue300}
                        onPress={saveZelleHandler} iconSize={28}/>
                    </View>
                </View>
            </View>
        </ScrollViewHelper>
