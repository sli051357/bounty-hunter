...
function LeaderboardFriendTab({username, rating, userImage, rank, friendProfilePage}) {
    
    return (
    <Pressable onPress={friendProfilePage} style={({pressed}) => pressed && styles.pressed}>
