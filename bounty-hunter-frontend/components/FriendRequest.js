        ...
        <View style={styles.card}>
            ...
            <View style={{flexDirection: 'row', marginLeft: 'auto',}}>
                ...
                <Pressable onPress={(addRequest)}>
                    <FontAwesome name="check" size={20} color={GLOBAL_STYLES.colors.brown300} />
                </Pressable>
                </View>

                <View style={[styles.button, {backgroundColor: GLOBAL_STYLES.colors.orange300}]}>
                <Pressable onPress={(deleteRequest)}>
                    <MaterialIcons name="delete" size={20} color={GLOBAL_STYLES.colors.brown300} />
                </Pressable>
                </View>
            </View>
