...
urlpatterns = [
    path('profiles/<slug:request_username>/display-name/', views.display_name, name="display_name"),
    path('profiles/change-display-name/', views.set_display_name, name="display_name"),
